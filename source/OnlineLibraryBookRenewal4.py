...
class BookDetail:
    def __init__(self,root, regno):
        self.root = root
        self.regno = regno
        self.Bookdetails = Frame(self.root, width = 900, height = 650, bg = 'dark turquoise')
        self.Bookdetails.place(x = 0, y = 0)
        self.detbutton = Button(self.Bookdetails, text = 'Previous Requests', font = fonts, bg = 'white', fg = 'steel blue', cursor = 'hand2', activebackground = 'Rosy Brown1',command= self.req_books)
        self.detbutton.place(x = 320, y = 200)
        self.detlabel2 = Button(self.Bookdetails, text = 'Present Book details', font = fonts, bg = 'white', command = self.details, fg = 'steel blue', cursor = 'hand2', activebackground = 'Rosy Brown1')
    ...
    def req_books(self):
        self.Bookdetails.destroy()
        req = Requestedbooks(root)
class Requestedbooks:
    def __init__(self,root):
        self.root = root
        self.query = f"SELECT * FROM renewed"
        ...
        self.tree.column('Fine', width=200, anchor='center')
        ...
        self.back_btn = Button(self.Requested_frame, text = 'BACK', bg = 'white', fg = 'steel blue', command = self.back, cursor = 'hand2', activebackground = 'Rosy Brown1',font = ('Times New Roman', 20, 'bold'))
        self.back_btn.place(x = 400, y = 500)
    def back(self):
        self.Requested_frame.destroy()
        backFrame = Login(root)
...
class Detail:
    def __init__(self, root, regno):
        ...
        self.back_btn = Button(self.Detail_frame, text = 'BACK', bg = 'white', fg = 'steel blue', command = self.back, cursor = 'hand2', activebackground = 'Rosy Brown1',font = ('Times New Roman', 20, 'bold'))
...
class librarianlog:
    def __init__(self, root):
        ...
        #label for reg.no
        self.LID_label = Label(self.lib_frame, text = 'Librarian ID', font = fonts, bg = 'dark turquoise', fg = 'navy', width =40)
...
class Req_Details:
    def __init__(self, root):
        ...
        #label for button
        self.Req_btn = Button(self.Req_details_frame, text = 'Show Renewal Requests', bg = 'white', fg = 'steel blue',command = self.view, font = fonts, cursor = 'hand2', activebackground = 'Rosy Brown1')
...
class ViewRequests:
    def __init__(self, root):
        ...
        for row in self.result: 
            self.tree.insert('', 'end', values=row)
        #label for back_button
        self.submit_btn = Button(self.Requests_frame, text = 'Renew', bg = 'white', fg = 'steel blue', command = self.renew, cursor = 'hand2', activebackground = 'Rosy Brown1',font = fonts)
        self.submit_btn.place(x = 420, y = 200)
        self.back_btn = Button(self.Requests_frame, text = 'BACK', bg = 'white', fg = 'steel blue', command = self.back, cursor = 'hand2', activebackground = 'Rosy Brown1',font = ('Times New Roman', 20, 'bold'))
    ...
    def renew(self):
        self.book_no_label = Label(self.Requests_frame, text = 'Book Id', font = fonts, fg = 'navy', width =40)
        self.book_no_label.place(x = 50, y = 400)
        self.book_no_entry = Entry(self.Requests_frame, width  = 13, font = fonts, bg = 'white')
        self.book_no_entry.place(x = 490, y = 400)
        self.submit_btn = Button(self.Requests_frame, text = 'Submit', bg = 'white', fg = 'steel blue',command = self.details, cursor = 'hand2', activebackground = 'Rosy Brown1',font = fonts)
        self.submit_btn.place(x = 400, y = 550)
...
class Fine:
    def __init__(self,root, bid):
        ...
        cursor.execute(self.query)
        self.result = cursor.fetchone()
        self.fine_frame = Frame(self.root, width = 900, height = 650, bg = 'dark turquoise')
        self.fine_frame.place(x = 0, y = 0)

        self.head_label = Label(self.fine_frame, text = 'Book Details', font = ('Times New Roman', 30, 'bold'), bg = 'dark turquoise', fg = 'navy', width =30)
        self.head_label.place(x = 70, y = 40)

        self.Bid_label = Label(self.fine_frame, text = 'Book Id :', font = fonts, bg = 'dark turquoise', fg = 'navy', width =30)
        self.Bid_label.place(x = 50, y = 100)
        self.Bid_label_text = Label(self.fine_frame, text = self.result[0], font = fonts, bg = 'dark turquoise', fg = 'navy', width =5)
        self.Bid_label_text.place(x = 450, y = 100)
        
        self.BName_label = Label(self.fine_frame, text = 'Book Name :', font = fonts, bg = 'dark turquoise', fg = 'navy', width = 10)
        self.BName_label.place(x = 250, y = 150)
        self.BName_label_text = Label(self.fine_frame, text = self.result[1], font = fonts, bg = 'dark turquoise', fg = 'navy', width = 5)
        self.BName_label_text.place(x = 450, y = 150)

        self.Idate_label = Label(self.fine_frame, text = 'IssuedDate :', font = fonts, bg = 'dark turquoise', fg = 'navy', width = 10)
        self.Idate_label.place(x = 210, y = 200)
        self.Idate_label_text = Label(self.fine_frame, text = self.result[2], font = fonts, bg = 'dark turquoise', fg = 'navy', width = 10)
        self.Idate_label_text.place(x = 410, y = 200)

        self.Ddate_label = Label(self.fine_frame, text = 'DueDate :', font = fonts, bg = 'dark turquoise', fg = 'navy', width = 10)
        self.Ddate_label.place(x = 210, y = 250)
        self.Ddate_label_text = Label(self.fine_frame, text = self.result[3], font = fonts, bg = 'dark turquoise', fg = 'navy', width = 15)
        self.Ddate_label_text.place(x = 350, y = 250)

        self.Sid_label = Label(self.fine_frame, text = 'Student Id :', font = fonts, bg = 'dark turquoise', fg = 'navy', width = 10)
        self.Sid_label.place(x = 200, y = 300)
        self.Sid_label_text = Label(self.fine_frame, text = self.result[4], font = fonts, bg = 'dark turquoise', fg = 'navy', width = 15)
        self.Sid_label_text.place(x = 350, y = 300)
        
        self.newduedate_label = Label(self.fine_frame, text = 'Enter updated due date :', font = fonts, bg = 'dark turquoise', fg = 'navy', width = 20)
        self.newduedate_label.place(x = 190, y = 350)
        self.newduedate_entry = DateEntry(self.fine_frame, width  = 13, font = fonts, bg = 'white')
        self.newduedate_entry.place(x = 490, y = 350)

        self.completed_btn = Button(self.fine_frame, text = 'BOOK RENEWED', bg = 'white', fg = 'steel blue', command = self.prompt,  cursor = 'hand2', activebackground = 'Rosy Brown1',font = fonts)
        self.completed_btn.place(x = 100, y = 400)

        self.back_btn = Button(self.fine_frame, text = 'BACK', bg = 'white', fg = 'steel blue', command = self.back,  cursor = 'hand2', activebackground = 'Rosy Brown1',font = ('Times New Roman', 10, 'bold'), width=5, height=1)
        self.back_btn.place(x = 20, y = 20)

    def applyFine(self):
        self.applyfine_label = Label(self.fine_frame, text = 'Enter fine :', font = fonts, bg = 'dark turquoise', fg = 'navy', width = 20)
        ...
        self.applyfine_label = Label(self.fine_frame, text = 'Enter 0 if no fine', font = fonts, bg = 'dark turquoise', fg = 'navy', width = 20)
        self.applyfine_label.place(x = 525, y = 500)
        self.submit_btn = Button(self.fine_frame, text = 'SUBMIT', bg = 'white', fg = 'steel blue', command = self.submit,  cursor = 'hand2', activebackground = 'Rosy Brown1',font = fonts)
    ...
    def prompt(self):
        ...
        if self.newduedate:
            ...
            self.apply_fine_btn = Button(self.fine_frame, text = 'APPLY FINE', bg = 'white', fg = 'steel blue', command = self.applyFine, cursor = 'hand2', activebackground = 'Rosy Brown1',font = fonts)
...
class UploadDetails:
    def __init__(self,root):
        ...
        self.Idate_entry = DateEntry(self.Upload_details_frame, width  = 13, font = fonts, bg = 'white')
        ...
        self.Ddate_entry = DateEntry(self.Upload_details_frame, width  = 13, font = fonts, bg = 'white')
        self.Ddate_entry.place(x = 485, y = 300)
        #label for button
        self.upload_btn = Button(self.Upload_details_frame, text = 'UPLOAD', bg = 'white', fg = 'steel blue', font = fonts,  command = self.validate, cursor = 'hand2', activebackground = 'Rosy Brown1')
...
class Welcome:
    def __init__(self, root):
        ...
        self.Wellabel = Label(self.Welcomeframe, text = 'ONLINE LIBRARY BOOK', font = ('Times New Roman', 35, 'bold'), bg = 'dark turquoise', fg = 'navy')
        self.Wellabel.place(x = 150, y = 50)
        self.Wellabel2 = Label(self.Welcomeframe, text = 'RENEWAL !!!',font = ('Times New Roman', 35, 'bold'), bg = 'dark turquoise', fg = 'navy')
