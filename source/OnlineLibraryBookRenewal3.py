...
class Detail:
    def __init__(self, root, regno):
        ...
        self.submit_btn.place(x = 400, y = 300)
        ...
        self.back_btn.place(x = 300, y = 300)
...
class ViewRequests:
    def __init__(self, root):
        self.root = root
        self.Requests_frame = Frame(self.root, width = 900, height = 650, bg = 'dark turquoise')
        self.Requests_frame.place(x = 0, y = 0)
...
if __name__ == "__main__":
    ...
    p1 = PhotoImage(file='..//assets//bookicon.png')
